  ...
  useEffect(() => {
    fetch('/api', {
      ...
      .then((data) => {
        ...
        dashboardStates.setVisits(data.report[0].views);
      })
      .catch((error) => {
  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        ...
        {/* Conversion Card */}
        <CardDataStats title="Conversion" subtitle="Leads/Visits" total={dashboardStates.leadsVisitsCvRateString} rate={dashboardStates.leadsVisitsCvRateString} levelUp={dashboardStates.levelUpLeadsVisitsCv}
        >
          <ShoppingBag />
        </CardDataStats>
